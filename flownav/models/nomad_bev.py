...
class NoMaD_ViNT(nn.Module):
    def __init__(
        ...
        bev_path: Optional[str] = '/home/theyanesh.er/flownav/flownav/models/bev/8x5_5e-4_rgb12_22:43:46',
    ) -> None:
        """
    ...
    def forward(
        ...
        goal_pos_encoding = self.action_encoder(goal_pose)
        ...
        # breakpoint()
        obs_encoding = torch.cat((obs_encoding, bev, goal_encoding), dim=1)
...
def bev_infer(model, rgb_camXs, intrins, rots, trans, device='cuda', config = bev_config):
    ...
    in_occ_mem0 = None # not using radar/lidar input for BEV

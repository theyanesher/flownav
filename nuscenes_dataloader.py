...
class NuScenesTemporalDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return {
            ...
            "context_imgs": context_imgs,          # [context_len+1, 3, H, W]
            "future_odom": relative_odom,          # [future_len, 3]
            "goal_img": goal_img,                  # [3, H, W] or None
            "intrinsics": repeated_intrin,         # [6, 3, 3]
            "context_intrins": context_intrins,    # [6, 3, 3]
            "context_rots": context_rots,          # [6, 3, 3]
            "context_trans": context_trans,        # [6, 3]
